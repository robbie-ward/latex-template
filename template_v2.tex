...
\newcommand{\papertitle}{Why they do that? An investigation.}
...
\usepackage{helvet}                    % document's serif font, in the style of minion pro | crimson,  utopia is nice too, so is cochineal

%\usepackage{utopia} 
%\usepackage[adobe-utopia]{mathdesign}
% document's sans serif font, helvetica
%\usepackage{erewhon}
...
\geometry{
	...
	right=3cm}
\setstretch{1.618}              % line spacing originally 1.02
...
\hypersetup{
	...
	citecolor = offblack, % add link color DarkSlateGray
	urlcolor = offblack, % add url color LightCoral
	linkcolor = offblack,
...
\definecolor{offblack}{gray}{0.07} % defines the shade of black used throughout
\color{offblack} % sets off black 
...
\begin{document}
	...
	\begin{abstract}
		...
		%	\noindent	\small{{\textbf{Keywords:}} Interdisciplinarity, Evaluation, Information Theory, Natural Language Processing, Sociology of Science, Bibliometrics}
	\end{abstract}
	%\vspace{2em}
